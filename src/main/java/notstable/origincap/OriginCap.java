                ...
                dispatcher.register(literal("origincap")
                        ...
                        .then(literal("cap")
                                .then(literal("get").executes(context -> {
                                    context.getSource().sendFeedback(Text.literal("current origin cap is: " + OriginCapStruct.getCap()), true);
                        ...
                        .then(literal("blacklist")
                                .then(literal("origin")
                                        ...
                                        .then(literal("list").executes(context -> {
                                            if (OriginCapStruct.originBlacklist.isEmpty()) {
                                            ...
                                            for (String originID : OriginCapStruct.originBlacklist.blackList) {
                                                try {
                                                    list += "\n" + originID;
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                        ...
                                        .then(literal("add")
                                                .then(argument("origin", OriginArgumentType.origin()).executes(context -> {
                                                    ...
                                                    try {
                                                        OriginCapStruct.originBlacklist.add(originID);
                                        ...
                                        .then(literal("remove")
                                                .then(argument("origin", OriginArgumentType.origin()).executes(context -> {
                                                    ...
                                                    String originID = OriginArgumentType.getOrigin(context, "origin").getIdentifier().toString();
                                                    try {
                                                        OriginCapStruct.layerBlacklist.remove(originID);
                                        ...
                                        .then(literal("clear").executes(context -> {
                                            ...
                                            OriginCapStruct.originBlacklist.clear();
                                ...
                                .then(literal("layer")
                                        ...
                                        .then(literal("add")
                                                .then(argument("layer", LayerArgumentType.layer()).executes(context -> {
                                                    ...
                                                    try {
                                                        OriginCapStruct.layerBlacklist.add(layerID);
                                        ...
                                        .then(literal("remove")
                                                .then(argument("layer", LayerArgumentType.layer()).executes(context -> {
                                                    ...
                                                    String layerID = LayerArgumentType.getLayer(context, "layer").getIdentifier().toString();
                                                    try {
                                                        OriginCapStruct.layerBlacklist.remove(layerID);
                                        ...
                                        .then(literal("clear").executes(context -> {
                                            ...
                                            OriginCapStruct.layerBlacklist.clear();
                                ...
                                .then(literal("player")
                                        ...
                                        .then(literal("list").executes(context -> {
                                            if (OriginCapStruct.playerUUIDBlacklist.isEmpty()) {
                                                context.getSource().sendFeedback(Text.literal("Player blacklist is empty"), false);
                                                return 0;
                                            }
                                            String list = "player blacklist: ";
                                            for (String uuid : OriginCapStruct.playerUUIDBlacklist.blackList) {
                                                try {
                                        ...
                                        .then(literal("add")
                                                .then(argument("playerName", StringArgumentType.string()).executes(context -> {
                                                    ...
                                                    try {
                                                        ...
                                                        OriginCapStruct.playerUUIDBlacklist.add(uuid);
                                        ...
                                        .then(literal("remove")
                                                .then(argument("playerName", StringArgumentType.string()).executes(context -> {
                                                    ...
                                                    try {
                                                        ...
                                                        OriginCapStruct.playerUUIDBlacklist.remove(uuid);
                        ...
                        .then(literal("clear")
                                ...
                                .then(literal("origin")
                                        .then(argument("origin", OriginArgumentType.origin()).executes(context -> {
                                            ...
                                            OriginCapStruct.clearOriginFromCap(id);
                                ...
                                .then(literal("layer")
                                        .then(argument("layer", LayerArgumentType.layer()).executes(context -> {
                                            ...
                                            OriginCapStruct.clearCapLayer(id);
                                            context.getSource().sendFeedback(Text.literal("cleared " + id + " from cap"), true);
                                            return 1;
                                        })))
                                .then(literal("player")
                                        .then(argument("playerName", StringArgumentType.string()).executes(context -> {
                                            ...
                                            try {
                                                ...
                                                OriginCapStruct.removePlayerAllLayers(uuid);
